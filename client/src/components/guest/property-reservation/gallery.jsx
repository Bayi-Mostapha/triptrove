...
export default function PlaceGallery({ place }) {
    ...
    if (showAllPhotos) {
        return (
            <div className="absolute z-[9999] inset-0 bg-black text-white min-h-screen">
                <div className="bg-black p-8 grid gap-6">
                    <div>
                        <h2 className="text-3xl mr-48">Photos of {place.title}</h2>
                        <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-8 text-sm flex items-center gap-1 py-2 px-3 rounded-md shadow shadow-black bg-white text-black">
    ...
    return (
        <div className="relative">
            ...
            <button onClick={() => setShowAllPhotos(true)} className="flex items-center gap-1 text-sm absolute bottom-2 right-2 py-2 px-3 bg-white rounded-md border border-black shadow-gray-500">
